...
$(document).ready(function() {
    ...
    $('#form-editar-cargos').on('submit', function(e){  
      ...
      $('#escolaridade-min-edit').val() == 0 || $('#escolaridade-max-edit').val() == 0
        ...
        $.ajax({
          url: '/claro/cadastro-cargos/editar',
          type: 'POST',
          data: data
        }).done(function(data){
          ...
          $("#redirect-alert").attr("href", "/claro/cadastro-cargos");
          $('#alert-ok').show();
    ...
    $('#confirmar-exclusao').on('click', function(e){
      ...
      $.ajax({
        url: '/claro/cadastro-cargos/deletar/' + id,
        method: 'POST',
        data: {'id': id},
    ...
    $('#tabela-cargos').DataTable({
      "drawCallback":function(){
        ...
        $('a[id^="botao-editar-"]').on('click', function(e){
          ...
          $('#id-editar').val(id);
          $.ajax({
            url: '/claro/cadastro-cargos/visualizar/' + id,
            method: 'POST',
            data: {'id': id}
          }).done(function(data){
            data = JSON.parse(data);
