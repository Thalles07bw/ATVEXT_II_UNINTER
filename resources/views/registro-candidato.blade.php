<html>
  ...
  <head>
    ...
    <title>Basis | Registro de usuários</title>
      ...
      <div class="register-box register-box-cadastro" >
        <div class="card card-outline card-orange card-max-wdt mx-auto">
          ...
          <div class="card-body">
            ...
            <a href="/teste/login-candidato" class="text-center">Eu já tenho um registro</a>
          </div>
          <!-- /.form-box -->
        </div><!-- /.card -->
      </div>
  ...
  <footer>
    ...
    <script src="resources/js/validation/valida-registro-candidato.js"></script>
