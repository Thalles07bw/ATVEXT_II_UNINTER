<html>
  ...
  <head>
    ...
    <title>Quero Trampar | Recuperação de Senha</title>
        ...
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-12" style="text-align: right; padding-top: 15px">             
                <a href="/login-candidato">Retornar a página de Login</a>              
            </div>
          </div>
        </div>
      </div>
  ...
  <footer>
    ...
    <script type="text/javascript" src="/js/validation/valida-recupera-senha-candidato.js"></script>
  </footer>
</html>