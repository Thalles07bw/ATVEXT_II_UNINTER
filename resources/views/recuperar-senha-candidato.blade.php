<html>
        ...
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-12" style="text-align: right; padding-top: 15px">             
                <a href="/teste/login-candidato">Retornar a página de Login</a>              
            </div>
          </div>
        </div>
      </div>
  ...
  <footer>
    ...
    <script type="text/javascript" src="resources/js/validation/valida-recupera-senha-candidato.js"></script>
  </footer>
</html>